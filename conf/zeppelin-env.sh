...
##
# export SPARK_HOME                             # (required) When it is defined, load it instead of Zeppelin embedded Spark librarie
# export SPARK_SUBMIT_OPTIONS                   # (optional) extra options to pass to spark submit. eg) "--driver-memory 512M --executor-memory 1G"
export SPARK_SUBMIT_OPTIONS="--packages org.apache.spark:spark-streaming-kinesis-asl_2.11:2.2.0 databricks:spark-deep-learning:0.1.0-spark2.1-s_2.11"
